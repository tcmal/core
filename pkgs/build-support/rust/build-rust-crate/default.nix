...
{ lib, stdenv, defaultCrateOverrides, fetchCrate, pkgsBuildBuild, rustc, cargo
, jq, libiconv }:
  ...
  in stdenv.mkDerivation (rec {
    ...
    configurePhase = configureCrate {
      inherit crateName buildDependencies completeDeps completeBuildDeps
        ...
        workspace_member release libPath crateVersion crateLinks extraLinkFlags
        extraRustcOptsForBuildRs crateLicense crateLicenseFile crateReadme
        crateRepository crateRustVersion crateAuthors crateHomepage verbose
        colors codegenUnits;
    };
