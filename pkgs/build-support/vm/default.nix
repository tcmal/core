  ...
  fillDiskWithRPMs = { size ? 4096, rpms, name, fullName, preInstall ? ""
    ...
    runInLinuxVM (stdenv.mkDerivation {
      ...
      buildCommand = ''
        ...
        PATH=/usr/bin:/bin:/usr/sbin:/sbin $chroot /mnt \
          rpm -iv --nosignature ${
            lib.optionalString (!runScripts) "--noscripts"
          } $rpms
  ...
  */
  ...
  debDistros = {
    ...
    debian11i386 = {
      ...
      packagesList = fetchurl {
        url =
          "https://snapshot.debian.org/archive/debian/20231124T031419Z/dists/bullseye/main/binary-i386/Packages.xz";
    ...
    debian11x86_64 = {
      ...
      packagesList = fetchurl {
        url =
          "https://snapshot.debian.org/archive/debian/20231124T031419Z/dists/bullseye/main/binary-amd64/Packages.xz";
    ...
    debian12i386 = {
      ...
      packagesList = fetchurl {
        url =
          "https://snapshot.debian.org/archive/debian/20231124T031419Z/dists/bookworm/main/binary-i386/Packages.xz";
    ...
    debian12x86_64 = {
      ...
      packagesList = fetchurl {
        url =
          "https://snapshot.debian.org/archive/debian/20231124T031419Z/dists/bookworm/main/binary-amd64/Packages.xz";
