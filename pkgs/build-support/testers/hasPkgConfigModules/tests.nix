...
lib.recurseIntoAttrs {
  ...
  zlib-has-meta-pkgConfigModules =
    testers.hasPkgConfigModules { package = zlib; };
  ...
  openssl-has-all-meta-pkgConfigModules =
    testers.hasPkgConfigModules { package = openssl; };

  zlib-does-not-have-ylib = runCommand "zlib-does-not-have-ylib" {
    failed = testers.testBuildFailure (testers.hasPkgConfigModules {
      package = zlib;
      moduleNames = [ "ylib" ];
    });
  } ''
