...
let
  ...
  inherit (pkgs)
    autoconf automake checkinstall clang-analyzer cov-build
    enableGCOVInstrumentation lcov libtool makeGCOVReport runCommand stdenv
    vmTools xz;
...
in rec {
  ...
  sourceTarball = args:
    ...
    ({ inherit lib stdenv autoconf automake libtool; } // args);
