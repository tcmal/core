...
, bootstrapFiles ? let
  table = {
    glibc = {
      ...
      armv5tel-linux =
        import ./bootstrap-files/armv5tel-unknown-linux-gnueabi.nix;
      armv6l-linux =
        import ./bootstrap-files/armv6l-unknown-linux-gnueabihf.nix;
      armv7l-linux =
        import ./bootstrap-files/armv7l-unknown-linux-gnueabihf.nix;
      ...
      powerpc64-linux =
        import ./bootstrap-files/powerpc64-unknown-linux-gnuabielfv2.nix;
      powerpc64le-linux =
        import ./bootstrap-files/powerpc64le-unknown-linux-gnu.nix;
    ...
    musl = {
      ...
      armv6l-linux =
        import ./bootstrap-files/armv6l-unknown-linux-musleabihf.nix;
  ...
  archLookupTable = table.${localSystem.libc} or (throw
        ...
        overrides = self: super:
          {
            ...
            libidn2 =
              import ../../by-name/li/libidn2/no-bootstrap-reference.nix {
                inherit lib;
