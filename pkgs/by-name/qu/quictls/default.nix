{ buildPackages, cryptodev, enableSSL2 ? false, enableSSL3 ? false
, fetchFromGitHub, lib, makeWrapper, perl, removeReferencesTo
, static ? stdenv.hostPlatform.isStatic, stdenv, withCryptodev ? false }:
...
stdenv.mkDerivation (finalAttrs: {
  ...
  configureFlags = [
    ...
    ++ lib.optional
    (stdenv.isLinux && lib.versionAtLeast finalAttrs.version "3.0.0")
  ...
  meta = {
    changelog =
      "https://github.com/quictls/openssl/blob/${finalAttrs.src.rev}/CHANGES.md";
