...
, withoutTargetLibc, libcCross, threadsCross, version
...
let
  ...
  configureFlags =
    ...
    ++ lib.optionals (targetPlatform.isMips && targetPlatform.parsed.abi.name
      == "gnu" && lib.versions.major version == "12")
    [ "--disable-libsanitizer" ] ++ lib.optionals targetPlatform.isAlpha [
