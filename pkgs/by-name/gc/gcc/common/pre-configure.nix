{ lib, stdenv, version, buildPlatform, hostPlatform, targetPlatform
, gnat-bootstrap ? null, langAda ? false, langFortran, langJava ? false
, langJit ? false, langGo, withoutTargetLibc, enableShared, enableMultilib
, pkgsBuildTarget }:
...
+ lib.optionalString (langFortran && (with stdenv;
