...
, openldap, libedit, keyutils, libverto, darwin
...
, staticOnly ? false, withLdap ? false, withVerto ? false }:
...
stdenv.mkDerivation rec {
  ...
  propagatedBuildInputs = lib.optionals stdenv.isDarwin
    (with darwin.apple_sdk; [ libs.xpc frameworks.Kerberos ]);
