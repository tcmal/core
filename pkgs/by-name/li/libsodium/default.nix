{ lib, stdenv, fetchurl, fetchpatch, autoreconfHook, testers }:
...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    (fetchpatch {
      ...
      url =
        "https://github.com/jedisct1/libsodium/commit/ffd1e374989197b44d815ac8b5d8f0b43b6ce534.patch";
  ...
  hardeningDisable =
    lib.optional (stdenv.hostPlatform.isMusl && stdenv.hostPlatform.isx86_32)
    "stackprotector";
