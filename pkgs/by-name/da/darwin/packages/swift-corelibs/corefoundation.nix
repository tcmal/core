{ lib, stdenv, fetchFromGitHub, fetchurl, makeSetupHook, cmake, pkg-config
, launchd, libdispatch, python3Minimal, libxml2, objc4, icu }:
...
in stdenv.mkDerivation {
  ...
  cmakeFlags = [ "-DBUILD_SHARED_LIBS=ON" "-DCF_ENABLE_LIBDISPATCH=OFF" ];
