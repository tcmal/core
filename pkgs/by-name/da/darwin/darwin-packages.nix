...
, makeScopeWithSplicing', stdenv, preLibcCrossHeaders, config, path }:
...
in makeScopeWithSplicing' {
  ...
  f = lib.extends aliases (self:
    let
      ...
      appleSourcePackages =
        pkgs.callPackage ./packages/apple-source-releases { } self;
      ...
      # macOS 11.0 SDK
      apple_sdk_11_0 =
        pkgs.callPackage ./packages/apple-sdk-11.0 { fetchurl = fetchurlBoot; };
    ...
    in impure-cmds // appleSourcePackages // chooseLibs // {
      ...
      postLinkSignHook =
        callPackage ./packages/signing-utils/post-link-sign-hook.nix { };
      ...
      inherit (pkgs.callPackages ./packages/xcode { })
        ...
        xcode_13_3_1 xcode_13_4 xcode_13_4_1 xcode_14 xcode_14_1 xcode_15
        xcode_15_1 xcode;
      ...
      swift-corelibs-foundation =
        callPackage ./packages/swift-corelibs/corefoundation.nix { };
