{ mkDerivation, writeShellScript, mtree, make, bsdSetupHook, netbsdSetupHook
, makeMinimal, mandoc, groff, rsync, compatIfNeeded, fts
...
in mkDerivation {
  ...
  nativeBuildInputs =
    [ bsdSetupHook netbsdSetupHook makeMinimal mandoc groff rsync ];
