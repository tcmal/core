{ lib, stdenv, llvm_meta, pkgsBuildBuild, monorepoSrc, runCommand, cmake, darwin
, ninja, python3, python3Packages, libffi
...
, enableSharedLibraries ? !stdenv.hostPlatform.isStatic, enablePFM ?
  ...
  && !stdenv.hostPlatform.isAarch, enablePolly ? true }:
