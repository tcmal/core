...
, libxml2, python3, fetchFromGitHub, fetchpatch, substitute, substituteAll
...
in let
  ...
  lldbPlugins = lib.makeExtensible (lldbPlugins:
    ...
    in { llef = callPackage ../common/lldb-plugins/llef.nix { }; });
    ...
    in {
      ...
      libcxx = callPackage ../common/libcxx {
        patches = [
          ...
          (fetchpatch {
            url =
              "https://github.com/llvm/llvm-project/commit/57c7bb3ec89565c68f858d316504668f9d214d59.patch";
...
in {
  inherit tools libraries release_version lldbPlugins;
