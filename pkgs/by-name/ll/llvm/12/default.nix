{ lowPrio, newScope, pkgs, lib, stdenv, cmake, preLibcCrossHeaders, substitute
, substituteAll, fetchFromGitHub, fetchpatch, libxml2, python3, isl, fetchurl
...
let
  ...
  inherit (import ../common/common-let.nix { inherit lib release_version; })
    llvm_meta;
  ...
  tools = lib.makeExtensible (tools:
    ...
    in {
      ...
      lld = callPackage ../common/lld {
        src =
          fetch "lld" "0qg3fgc7wj34hdkqn21y03zcmsdd01szhhm1hfki63iifrm3y2v9";
      ...
      lldb = callPackage ../common/lldb.nix {
        src =
          fetch "lldb" "0g3pj1m3chafavpr35r9fynm85y2hdyla6klj0h28khxs2613i78";
        patches = let
          resourceDirPatch = callPackage ({ substituteAll, libclang }:
            substituteAll {
  ...
  libraries = lib.makeExtensible (libraries:
    ...
    in {
      ...
      openmp = callPackage ../common/openmp {
        src =
          fetch "openmp" "14dh0r6h2xh747ffgnsl4z08h0ri04azi9vf79cbz7ma1r27kzk0";
        patches = [
          # Fix cross.
          (fetchpatch {
            url =
              "https://github.com/llvm/llvm-project/commit/5e2358c781b85a18d1463fd924d2741d4ae5e42e.patch";
