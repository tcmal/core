{ lib, stdenv, llvm_meta, patches ? [ ], src ? null, monorepoSrc ? null
, runCommand, substituteAll, cmake, ninja, libxml2, libllvm, release_version
, version, python3, buildLlvmTools, fixDarwinDylibNames, enableManpages ? false
  ...
  self = stdenv.mkDerivation (finalAttrs:
    rec {
      ...
      nativeBuildInputs = [ cmake ]
        ...
        ++ [ python3 ]
        ++ lib.optional (lib.versionAtLeast version "18" && enableManpages)
      ...
      cmakeFlags = (lib.optionals (lib.versionAtLeast release_version "15")
        ...
        ++ [ "-DCLANGD_BUILD_XPC=OFF" "-DLLVM_ENABLE_RTTI=ON" ]
        ++ lib.optionals (lib.versionAtLeast release_version "17")
        [ "-DLLVM_INCLUDE_TESTS=OFF" ] ++ lib.optionals enableManpages [
      ...
      passthru = {
        ...
        hardeningUnsupportedFlagsByTargetPlatform = targetPlatform:
          lib.optional (!(targetPlatform.isx86_64 || targetPlatform.isAarch64))
          "zerocallusedregs"
