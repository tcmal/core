...
# runtime deps
, click, ghp-import, importlib-metadata, jinja2, markdown, markupsafe, mergedeep
, packaging, pathspec, platformdirs, pyyaml, pyyaml-env-tag, watchdog

# optional-dependencies
, babel, setuptools

# testing deps
, mock, unittestCheckHook }:
