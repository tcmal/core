{ lib, python, fetchFromGitHub, fetchpatch2, buildPythonPackage, cython
, setuptools, libstemmer }:
...
buildPythonPackage rec {
  ...
  patches = [
    (fetchpatch2 {
      ...
      url =
        "https://github.com/snowballstem/pystemmer/commit/d3d423dc877b4f49e0ab1776f7edaff37feb6799.patch";
