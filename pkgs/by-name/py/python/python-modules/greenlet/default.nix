...
# tests
, objgraph, psutil, python, unittestCheckHook }:
...
let
  greenlet = buildPythonPackage rec {
    ...
    nativeCheckInputs = [ objgraph psutil unittestCheckHook ];
    ...
    passthru.tests.pytest =
      greenlet.overridePythonAttrs (_: { doCheck = true; });

    meta = with lib; {
      changelog =
        "https://github.com/python-greenlet/greenlet/blob/${version}/CHANGES.rst";
