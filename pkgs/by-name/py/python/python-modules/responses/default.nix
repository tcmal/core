{ lib, buildPythonPackage, fetchFromGitHub, fetchpatch2, pytest-asyncio
, pytest-httpserver, pytestCheckHook, pythonOlder, pyyaml, requests, setuptools
, tomli, tomli-w, types-pyyaml, types-toml, urllib3 }:
...
buildPythonPackage rec {
  ...
  patches = [
    (fetchpatch2 {
      ...
      url =
        "https://github.com/getsentry/responses/commit/d5e7402f1782692d04742562370abaca8d54a972.patch";
