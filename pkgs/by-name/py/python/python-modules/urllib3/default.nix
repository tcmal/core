...
, brotli, brotlicffi, pysocks

# tests
, backports-zoneinfo, pytestCheckHook, pytest-timeout, pythonOlder, tornado
, trustme }:
...
let
  self = buildPythonPackage rec {
    ...
    nativeCheckInputs = [ pytest-timeout pytestCheckHook tornado trustme ]
