...
, coverageAnalysis ? null, gawk, gmp, libffi, libtool, libunistring, libxcrypt
, makeWrapper, pkg-config, pkgsBuildBuild, readline, writeScript }:
...
in builder rec {
  ...
  patches = [ ./eai_system.patch ./guile-hurd-posix-spawn.patch ]
