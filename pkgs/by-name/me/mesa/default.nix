{ stdenv, lib, fetchurl, fetchpatch, fetchCrate, buildPackages, meson
, pkg-config, ninja, intltool, bison, flex, file, python3Packages
, wayland-scanner, expat, libdrm, xorg, wayland, wayland-protocols, openssl
, llvmPackages, libffi, libomxil-bellagio, libva-minimal, elfutils, libvdpau
, libglvnd, libunwind, lm_sensors, vulkan-loader, glslang, galliumDrivers ?
...
, enablePatentEncumberedCodecs ? true, jdupes, rustPlatform, rust-bindgen, rustc
...
let
  ...
  self = stdenv.mkDerivation {
    ...
    buildInputs = with xorg;
      ...
      [ elfutils ] ++ lib.optionals enableOpenCL [
        llvmPackages.libclc
        llvmPackages.clang
