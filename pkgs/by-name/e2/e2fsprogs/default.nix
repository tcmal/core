...
, texinfo, withFuse ? stdenv.isLinux, fuse, shared ?
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ libuuid gettext ] ++ lib.optionals withFuse [ fuse ];
  ...
  patches = [
    ...
    (fetchurl {
      ...
      url =
        "https://git.kernel.org/pub/scm/fs/ext2/e2fsprogs.git/plain/debian/patches/disable-metadata_csum_seed-and-orphan_file-by-default?h=debian/master&id=3fb3d18baba90e5d48d94f4c0b79b2d271b0c913";
