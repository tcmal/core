...
, pcre2, elfutils, linuxHeaders ? stdenv.cc.libc.linuxHeaders, gnutls, iptables
...
, withBootloader ? withEfi && !stdenv.hostPlatform.isMusl
  # "Unknown 64-bit data model"
  && !stdenv.hostPlatform.isRiscV32
  # adds bzip2, lz4, xz and zstd
, withCompression ? true, withCoredump ? true, withCryptsetup ? true
, withRepart ? true, withDocumentation ? true
, withEfi ? stdenv.hostPlatform.isEfi, withFido2 ? true
  # conflicts with the NixOS /etc management
, withFirstboot ? false, withHomed ? !stdenv.hostPlatform.isMusl
, withHostnamed ? true, withHwdb ? true
, withImportd ? !stdenv.hostPlatform.isMusl, withIptables ? true
, withKmod ? true, withLibBPF ?
...
, withPam ? true, withPasswordQuality ? true, withPCRE2 ? true
, withPolkit ? true, withPortabled ? !stdenv.hostPlatform.isMusl
, withQrencode ? true, withRemote ? !stdenv.hostPlatform.isMusl
, withResolved ? true, withShellCompletions ? true, withSysusers ? true
, withSysupdate ? true, withTimedated ? true, withTimesyncd ? true
, withTpm2Tss ? true
  # adds python to closure which is too much by default
, withUkify ? false, withUserDb ? true, withUtmp ? !stdenv.hostPlatform.isMusl
, withVmspawn ? true
...
in stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    ++ lib.optional (stdenv.hostPlatform.isPower || stdenv.hostPlatform.isRiscV
      || stdenv.hostPlatform.isMips) [
        ...
        (fetchpatch {
          url =
            "https://github.com/systemd/systemd/commit/8040fa55a1cbc34dede3205a902095ecd26c21e3.patch";
          sha256 = "0c6z7bsndbkb8m130jnjpsl138sfv3q171726n5vkyl2n9ihnavk";
        })
      ] ++ lib.optional stdenv.hostPlatform.isMusl (let
        oe-core = fetchzip {
          url =
            "https://git.openembedded.org/openembedded-core/snapshot/openembedded-core-6fdf03bd950e55ef7881041606f6e76141033716.tar.gz";
  ...
  buildInputs = [
    ...
    ++ lib.optional withKexectools kexec-tools ++ lib.optional withKmod kmod
    ++ lib.optional withLibidn2 libidn2
    ++ lib.optional withLibseccomp libseccomp
    ++ lib.optional withIptables iptables ++ lib.optional withPam pam
  ...
  mesonFlags = [
    ...
    # Mount
    (lib.mesonOption "mount-path"
      "${lib.getOutput "mount" util-linux}/bin/mount")
    (lib.mesonOption "umount-path"
      "${lib.getOutput "mount" util-linux}/bin/umount")
  ...
  mesonInstallTags =
    lib.optionals buildLibsOnly [ "devel" "libudev" "libsystemd" ];
  ...
  passthru = {
    ...
    inherit withBootloader withCryptsetup withEfi withHostnamed withImportd
      withKmod withLocaled withMachined withPortabled withTimedated withUtmp
      util-linux kmod kbd;

    tests = {
      inherit (nixosTests)
        switchTest systemd-journal systemd-journal-gateway
        systemd-journal-upload;
      cross = let
        systemString = if stdenv.buildPlatform.isAarch64 then
          "gnu64"
        else
          "aarch64-multiplatform";
      in pkgsCross.${systemString}.systemd;
    };
  };
