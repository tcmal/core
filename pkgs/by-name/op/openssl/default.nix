...
, makeWrapper, withCryptodev ? false, cryptodev ? null, withZlib ? false, zlib
    ...
    stdenv.mkDerivation (finalAttrs: {
      ...
      == stdenv.buildPlatform then
        ...
        if stdenv.hostPlatform.isx86_64 then
          ...
          "./Configure BSD-x86"
          + lib.optionalString stdenv.hostPlatform.isElf "-elf"
        else
      ...
      configureFlags = [
        ...
        ++ lib.optionals
        (stdenv.hostPlatform.isMips && stdenv.hostPlatform ? gcc.arch) [
