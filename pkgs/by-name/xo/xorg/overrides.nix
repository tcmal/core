{ callPackage, lib, stdenv, makeWrapper, fetchurl, fetchpatch, fetchFromGitLab
, buildPackages, automake, autoconf, libiconv, libtool, intltool, gettext
, python3, perl, freetype, tradcpp, fontconfig, meson, ninja, ed, fontforge
...
, hwdata, ApplicationServices, Carbon, Cocoa, Xplugin, xorg, windows }:
...
let
  ...
  addMainProgram = pkg:
    ...
    pkg.overrideAttrs
    (attrs: { meta = attrs.meta // { inherit mainProgram; }; });
...
in self: super:
{
  ...
  libXdmcp = super.libXdmcp.overrideAttrs (attrs: {
    outputs = [ "out" "dev" "doc" ];
    meta = attrs.meta // { pkgConfigModules = [ "xdmcp" ]; };
  });

  libXtst = super.libXtst.overrideAttrs
    (attrs: { meta = attrs.meta // { pkgConfigModules = [ "xtst" ]; }; });
  ...
  xdpyinfo = super.xdpyinfo.overrideAttrs (attrs: {
    ...
    preConfigure = attrs.preConfigure or ""
      ...
      '';
    meta = attrs.meta // { mainProgram = "xdpyinfo"; };
  });
  ...
  libXft = super.libXft.overrideAttrs (attrs: {
    ...
    '';
    passthru = attrs.passthru // { inherit freetype fontconfig; };
  });
  ...
  xf86inputkeyboard = super.xf86inputkeyboard.overrideAttrs (attrs: {
    meta = attrs.meta // {
      platforms = lib.platforms.freebsd ++ lib.platforms.netbsd
  ...
  xorgproto = super.xorgproto.overrideAttrs (attrs: {
    ...
    patches = [
      (fetchpatch {
        url =
          "https://aur.archlinux.org/cgit/aur.git/plain/meson.patch?h=mingw-w64-xorgproto&id=7b817efc3144a50e6766817c4ca7242f8ce49307";
  ...
  xrandr = super.xrandr.overrideAttrs (attrs: {
    ...
    '';
    meta = attrs.meta // { mainProgram = "xrandr"; };
  });
