...
, darwin, cargo, cmake, rustc, rustfmt, pkg-config, openssl, xz, libiconv, which
  ...
  in [
    ...
    "--target=${
      concatStringsSep "," ([
        ...
        (stdenv.buildPlatform != stdenv.targetPlatform && !fastCross) [
        ...
        (stdenv.hostPlatform != stdenv.targetPlatform && !fastCross)
